      ...
      <header className='bg-custom-15616D'>
        <div className='grid grid-cols-1 sm:grid-cols-2 justify-center'>
          ...
          <div className='flex flex-col gap-4 items-end sm:flex-row sm:items-center sm:justify-end'>
            {(userRole === "ADMIN" || userRole === "joueur" || userRole === "SUPPORTER") ? <Person avatar={userData?.avatar} firstname={userData?.firstname?userData.firstname: "John"} lastname={userData?.lastname?userData.lastname:"Doe"} role={userData?.role} /> : <SignupModal />}
